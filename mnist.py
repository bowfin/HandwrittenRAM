...
def train_images(data_dir=None):
    ...
    """
    return download_and_parse_mnist_file('train-images-idx3-ubyte.gz', data_dir)


def test_images(data_dir=None):
    ...
    test_images : numpy.ndarray
        ...
        columns of the image
    """
    return download_and_parse_mnist_file('t10k-images-idx3-ubyte.gz', data_dir)


def train_labels(data_dir=None):
    ...
    """
    return download_and_parse_mnist_file('train-labels-idx1-ubyte.gz', data_dir)


def test_labels(data_dir=None):
    ...
    test_labels : numpy.ndarray
        Numpy array with the labels 0 to 9 in the train MNIST database.
    """
    return download_and_parse_mnist_file('t10k-labels-idx1-ubyte.gz', data_dir)
